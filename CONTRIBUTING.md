...
micropub-endpoint-ruby is developed using Ruby 2.4.4 and is additionally tested against Ruby 2.5.3 using [Travis CI](https://travis-ci.com/jgarber623/micropub-endpoint-ruby).
